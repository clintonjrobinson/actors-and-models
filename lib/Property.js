...
class Property {
      ...
      if (value !== undefined && value !== null && value.constructor.name !== this._type.name) {
        ...
        if (this._type === String || this._type === Number) {
          ...
          if (value && value.__data && value.__data._type) {
            ...
            if (value.__data._type === value.constructor.name) {
              return value;
            }
          } else if (value && value._type && value._type !== this._type.name) {
  ...
  static serialize(property) {
    var str = `
      {
        type: ${property.type.isType ? 'Types.' + property.type.name : property.type.name},
