...
function RequiredUsers(Models) {
  ...
  function* ensureSystemUser() {
    Models.systemUser = yield User.mongo.findOne(User.collectionName, {
  ...
  function* ensureAnonymousUser() {
    try {
      Models.anonymousUser = yield User.get(Models.systemContext, {
  ...
  function* ensureAdministratorUser() {
    try {
      let administrator = yield User.get(Models.systemContext, {
