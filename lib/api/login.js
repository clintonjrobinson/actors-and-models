...
exports = module.exports = function(Models) {
  ...
  return function *() {
    ...
    if (Models.api && Models.api.beforeLogin) yield Models.api.beforeLogin.call(this, vars, upd);

    let result = yield User.mongo.findOneAndUpdate(User.collectionName, vars, upd, {fields: fields});
    ...
    if (Models.api && Models.api.afterLogin) yield Models.api.afterLogin.call(this, user);
