...
class Document extends Common {
  ...
  *update(context, doc, opts) {
    ...
    var ret = yield mongo.findAndModify(this.collectionName, {_id: doc._id}, {$set: this.delta(doc)}, {
      new: true,
      fields: opts.fields
    });
