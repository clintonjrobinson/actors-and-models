...
class Document extends Common {
  ...
  static *remove (context, doc) {
    ...
    var ret = yield mongo.findAndRemove(self.collectionName, {_id: id});
    ret = new this(ret);
  ...
  static *update (context, doc) {
    ...
    var ret = yield mongo.findAndModify(this.collectionName, {_id: doc._id}, {$set: doc.__data}, {new:true});
    ret =  new this(ret);
  ...
  static *create (context, doc) {
    ...
    var ret = yield mongo.insert(this.collectionName, doc.__data);
    ret = new this(ret);
