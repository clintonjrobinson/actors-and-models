...
class Common {
  constructor() {
    ...
    //Are languages even enabled on this model?
    if (this.constructor.isMultiLanguage && arguments[1]) {
      this.__language = arguments[1];
    }
...
Common.registerDefinition = function(definition, isModel) {
  ...
  var str = `
    class ${definition.name} extends Extend {
      ...
      static get isMultiLanguage() {
        return ${definition.multiLanguage === true};
      }
