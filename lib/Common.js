    ...
    var str = `{
      ...
      `;
        ...
        if (definition.secure) {
          str += `secure: ${JSON.stringify(definition.secure)}`;
        }
...
Common.registerDefinition = function(definition, isModel) {
  ...
  if (definition.extend) {
    if (definition.extend.constructor === 'String') {
      definition.extend =  isModel
        ? Document.models[definition.extend]
        : Structure.structures[definition.extend]
      ;
    }
