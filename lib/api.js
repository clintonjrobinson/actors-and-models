  ...
  router
    ...
    .get('me', function *() {
      ...
      if (this.query.format === 'jsonp') {
        this.type = 'application/javascript';
        this.body = `var user = ${JSON.stringify(data)};`;
        return;
      }
    ...
    .post(':model/count', function *() {
      ...
      if (model.api && model.api.middleware && model.api.middleware.beforeCount) {
        yield model.api.middleware.beforeCount.call(this, this.request.body.fields.query, opts);
      }

      let count = yield model.count(this, this.request.body.fields.query, opts);
    ...
    .post(':model/find', function *() {
      ...
      let opts = JSON.parse(JSON.stringify((this.request.body && this.request.body.fields && this.request.body.fields.options) ? this.request.body.fields.options : {}));
      opts.json = true;

      if (model.api && model.api.middleware && model.api.middleware.beforeFind) {
        yield model.api.middleware.beforeFind.call(this, this.request.body.fields.query, opts);
      }

      let found = yield model.find(this, this.request.body.fields.query, opts);
    ...
    .post(':model/create', function *() {
      ...
      if (model.api && model.api.middleware && model.api.middleware.beforeCreate) {
        yield model.api.middleware.beforeCreate.call(this, this.request.body.fields);
      }
