...
exports = module.exports = function(Models) {
  ...
  router
    ...
    .post(':model/count', function *() {
      ...
      this.body = yield model.count(this, this.request.body.fields.query, this.request.body.fields.options);
    })

    .post(':model/find', function *() {
      let model = Models.models[this.params.model];
      this.body = yield model.find(this, this.request.body.fields.query, this.request.body.fields.options);
    })
    ...
    .post(':model/:id/get', function *() {
      let model = Models.models[this.params.model];
      let id = new Models.Types.ObjectID(this.params.id);
      this.body = yield model.get(this, id, (this.request.body && this.request.body.fields) ? this.request.body.fields.options : {});
    })
    ...
    .post(':model/:id/*', function *() {
      let model = Models.models[this.params.model];
      let id = new Models.Types.ObjectID(this.params.id);

      let call = this.path.replace(Models.constants.API_PREFIX).split('');
